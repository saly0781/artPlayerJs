        ...
        async function initializeApp(optionData) {
            ...
            try {
                ...
                art.on('ready', () => {
                    ...
                    syncWidths(); updateActionButtonPosition();
                    const resizeObserver = new ResizeObserver(syncWidths);
                    if (qualityControlContainer) resizeObserver.observe(qualityControlContainer);
                    window.addEventListener('resize', updateActionButtonPosition);
